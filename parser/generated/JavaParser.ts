...
export class JavaParser extends antlr.Parser {
    ...
    private guardedPattern_sempred(localContext: GuardedPatternContext, predIndex: number): boolean {
        switch (predIndex) {
            case 17:
...
export class ExpressionContext extends antlr.ParserRuleContext {
    public _prefix: Token | null = null;
    public _bop: Token | null = null;
    public _postfix: Token | null = null;
    public constructor(parent: antlr.ParserRuleContext | null, invokingState: number) {
        super(parent, invokingState);
    }
