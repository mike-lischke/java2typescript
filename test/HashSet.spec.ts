...
describe("HashSet Tests", () => {
    ...
    it("Set Manipulation", () => {
        ...
        // The first parameter determines the hash code in the test class, so only the first and the third entries
        // are actually added.
    ...
    it("Set Equality", () => {
        ...
        set4.add(new Test(13, "13"));

        expect(set3.equals(set4)).toBeTruthy();
